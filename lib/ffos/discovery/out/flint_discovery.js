...
},{"eventemitter3":6}],2:[function(require,module,exports){
...
},{"./FlintDevice":1,"./SSDPManager":3,"eventemitter3":6}],3:[function(require,module,exports){
...
},{"./SSDPResponder":4,"eventemitter3":6}],4:[function(require,module,exports){
...
SSDPResponder = (function(_super) {
  ...
  SSDPResponder.ab2str = function(buf) {
  ...
  SSDPResponder.prototype._init = function() {
    ...
    return this.socket_.onmessage = (function(_this) {
      return function(event) {
        var data;
        data = SSDPResponder.ab2str(event.data);
...
},{"eventemitter3":6}],5:[function(require,module,exports){
window.FlintDeviceManager = require('./FlintDeviceManager');



},{"./FlintDeviceManager":2}],6:[function(require,module,exports){
'use strict';
